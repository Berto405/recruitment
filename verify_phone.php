                        ...
                        <div class="card-body">
                            ...
                            <form action="verify_phone_process.php" method="POST">
                                <div id="otp" class="inputs d-flex flex-row justify-content-center mt-2">
                                    <input class="m-2 text-center form-control rounded" type="text" name="firstNum"
                                        maxlength="1" required />
                                    <input class="m-2 text-center form-control rounded" type="text" name="secondNum"
                                        maxlength="1" required />
                                    <input class="m-2 text-center form-control rounded" type="text" name="thirdNum"
                                        maxlength="1" required />
                                    <input class="m-2 text-center form-control rounded" type="text" name="fourthNum"
                                        maxlength="1" required />
                                    <input class="m-2 text-center form-control rounded" type="text" name="fifthNum"
                                        maxlength="1" required />
                                    <input class="m-2 text-center form-control rounded" type="text" name="sixthNum"
                                        maxlength="1" required />
                                </div>
