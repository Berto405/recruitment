<?php
include ("src/shared/backend/login_process.php");
$pageTitle = "Login";
                        ...
                        <form action="" method="POST">
                            <div class="row gy-2 overflow-hidden">
                                ...
                                <div class="text-center mb-2">
                                    <small>
                                        Don't have account?
                                        <a href="/recruitment/src/shared/frontend/register.php"
                                ...
                                <div class="text-center">
                                    <small>
                                        ...
                                        <a href="/recruitment/src/shared/frontend/resend_verify_email.php"
                                            class="text-decoration-none">
                                            Resend
                                        </a>
                                    </small>
