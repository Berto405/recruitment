<?php
include ("src/shared/backend/home_process.php");
include ("src/shared/backend/apply_job_process.php");
$pageTitle = "Jobs List";
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-3 my-1">
                                <div class="dropdown mb-2">
                                    ...
                                    <div class="dropdown-menu" style="max-height: 300px; overflow-y: auto; width: 100%;"
                                        aria-labelledby="dropdownMenuButton1">
                                        <a class="dropdown-item" href="home?loc=Bacolod">Bacolod</a>
                                        <a class="dropdown-item" href="home?loc=Bicol">Bicol</a>
                                        <a class="dropdown-item" href="home?loc=Cagayan de Oro">Cagayan de
                                            Oro</a>
                                        <a class="dropdown-item" href="home?loc=Cavite">Cavite</a>
                                        <a class="dropdown-item" href="home?loc=Cebu">Cebu</a>
                                        <a class="dropdown-item" href="home?loc=Davao">Davao</a>
                                        <a class="dropdown-item" href="home?loc=General Santos">General
                                            Santos</a>
                                        <a class="dropdown-item" href="home?loc=Iloilo">Iloilo</a>
                                        <a class="dropdown-item" href="home?loc=Kalibo">Kalibo</a>
                                        <a class="dropdown-item" href="home?loc=Laguna">Laguna</a>
                                        <a class="dropdown-item" href="home?loc=Makati">Makati</a>
                                        <a class="dropdown-item" href="home?loc=Pampanga">Pampanga</a>
                                        <a class="dropdown-item" href="home?loc=Parañaque">Parañaque</a>
                                        <a class="dropdown-item" href="home?loc=Subic">Subic</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-3 my-1">
                            ...
                            <div class="col-md-6 col-lg-3 my-1">
                                <div class="dropdown mb-2">
                                    ...
                                    <div class="dropdown-menu" style="width: 100%;"
                                        ...
                                        <a class=" dropdown-item" href="index.php?type=Project-based">Project-based</a>
