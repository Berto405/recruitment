...
if (isset($_GET['loc'])) {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        $query =
            "SELECT * FROM mrfs 
            WHERE  mrfs.mrf_status = 'Post' AND mrfs.location LIKE '%$location%'";
        $result = mysqli_query($conn, $query);
    }
}
...
if (isset($_GET['type'])) {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        $query =
            "SELECT * FROM mrfs 
            WHERE  mrfs.mrf_status = 'Post' AND mrfs.job_type LIKE '%$jobType%'";
        $result = mysqli_query($conn, $query);
    }
}
...
if (isset($_GET['industry'])) {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        $query =
            "SELECT * FROM mrfs 
            WHERE  mrfs.mrf_status = 'Post' AND mrfs.job_type LIKE '%$industry%'";
        $result = mysqli_query($conn, $query);
    }
}
