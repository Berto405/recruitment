...
<h4 class=" mt-1 mb-5 ">Backout Applicants</h4>

<div class="row">
    <div class="col-md-6 col-lg-9">
        <div class="float-start ">
            <form action="../components/export_to_excel.php" method="post">
                <button type="submit" class="btn btn-success" name="backoutExportBtn" style="border-radius: 0;">
