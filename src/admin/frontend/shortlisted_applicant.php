<?php
include ("src/admin/backend/applicant_process.php");
    ...
    <div class="col-md-6 col-lg-9">
        <div class="float-start ">
            <form action="../components/export_to_excel.php" method="post">
                <button type="submit" class="btn btn-success" name="shortlistedExportBtn" style="border-radius: 0;">
                            ...
                            <th class="bg-danger text-white text-center">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu text-center shadow" aria-labelledby="dropdownUser2">
                                        ...
                                        <li class="mb-1">
                                            <button type="button" id="backBtn" class="dropdown-item text-warning mb-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content rounded-4 shadow">
                            ...
                            <div class="modal-body p-5 pt-0">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            <div class="form-floating">
                                                <input type="text" id="remark" class="form-control" placeholder="rekamr"
                                                    name="remark">
                                ...
                                <button class="w-100 mb-2 btn btn-lg rounded-3 btn-danger" id="action" type="submit">
                                    Submit
                                </button>
                            </div>
                        </div>
