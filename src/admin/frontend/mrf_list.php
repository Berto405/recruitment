<?php
include ('src/admin/backend/mrf_list_process.php');
$pageTitle = "MRF List";
    ...
    <div class="col-md-6 col-lg-9">
        <div class="float-start ">
            <form action="../components/export_to_excel.php" method="post">
                <button type="submit" class="btn btn-success" name="mrfListExportBtn" style="border-radius: 0;">
        ...
        <div class="table-responsive">
            <table id="jobsTable" class="table table-hover table-bordered bg-white border">
                <thead class="bg-danger ">
                    <tr>
                        <th class="bg-danger text-white nowrap">Actions</th>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <!-- Post Job Modal -->
                            <div class="modal fade" tabindex="-1" role="dialog" id="postJobModal<?php echo $row['id'] ?>"
                                aria-hidden="true">
                                    ...
                                    <div class="modal-content rounded-4 shadow">
                                        ...
                                        <div class="modal-body p-5 pt-0">
                                            <form action="" method="post">
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-sm-12 col-md-3 ">
                                                        <div class="form-floating">
                                                            <select class="form-select fw-bold mb-sm-3" name="industry"
                                                    ...
                                                    <div class="col-sm-12 col-md-3 ">
                                                        <div class="form-floating">
                                                            <select class="form-select fw-bold mb-sm-3" name="location"
                                                            ...
                                                            <label for="location" class="form-label fw-bold">Location of
                                                                Deployment</label>
                                                    ...
                                                    <div class="col-sm-12 col-md-3 ">
                                                        <div class="form-floating">
                                                            <select class="form-select fw-bold mb-sm-3" name="newRequest"
                                                                id="newRequest" required>
                                                    ...
                                                    <div class="col-sm-12 col-md-3 ">
                                                        <div class="form-floating mb-sm-3">
                                                            <select class="form-select fw-bold " name="classification"
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-sm-12 col-md-3">
                                                        <div class="form-floating mb-3">
                                                            <input type="text" class="form-control rounded-3 fw-bold"
                                                                ...
                                                                value="<?php echo $row['job_position']; ?>" required>
                                                    ...
                                                    <div class="col-sm-12 col-md-3">
                                                        <div class="form-floating mb-sm-3">
                                                            ...
                                                            <label for="contractType" class="form-label fw-bold">Contract
                                                                Type</label>
                                                        </div>
                                                    </div>
                                                ...
                                                <button class="w-100 mb-2 btn btn-lg rounded-3 btn-danger" name="postBtn"
                                                    type="submit">
                                                    Submit
                                                </button>
                                            </form>
