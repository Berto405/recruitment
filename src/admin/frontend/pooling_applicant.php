...
$query =
    ...
    WHERE job_applicants.application_status IN ('Pending', 'Pooling', 'Pooled', 'Back to Pooling') 
...
<div class="row">
    <div class="col-md-6 col-lg-9">
        <div class="float-start ">
            <form action="/recruitment/components/export_to_excel.php" method="post">
                <button type="submit" class="btn btn-success" name="poolingExportBtn" style="border-radius: 0;">
