...
$query =
    ...
    WHERE job_applicants.application_status IN ('Hired', 'Ongoing Requirements', 'Onboarding', 'Waiting for Start Date', 'Placed with Ongoing Req.', 'Placed with Onboarding') AND job_applicants.employee_id = $emp_id
    ";
