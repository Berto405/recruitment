...
<div class="accordion p-1" id="accordionExample">
    <ul class="nav flex-column mt-5">
        ...
        <li>
            <a href="#"
                class="nav-link  bg-opacity-25 p-2 ps-4 text-danger <?php echo ($_SERVER['REQUEST_URI'] == '/recruitment/admin/add_job.php' || $_SERVER['REQUEST_URI'] == '/recruitment/admin/mrf_list.php') ? 'bg-danger' : ''; ?>"
        ...
        <div class="collapse <?php echo ($_SERVER['REQUEST_URI'] == '/recruitment/admin/add_job.php' || $_SERVER['REQUEST_URI'] == '/recruitment/admin/mrf_list.php') ? 'show' : ''; ?>"
            ...
            <ul class="btn-toggle-nav list-unstyled fw-normal m-0 mb-2 p-0">
                ...
                <li class="my-1 menu_">
                    <a href="../admin/mrf_list.php"
                        class="nav-link p-2 ps-4 ps-5 <?php echo ($_SERVER['REQUEST_URI'] == '/recruitment/admin/mrf_list.php') ? 'border-end border-danger border-5 bg-danger text-white' : 'text-danger'; ?>">
